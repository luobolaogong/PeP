    ...
    public boolean process(Patient patient) {
        ...
        if (useNotesTemplate) {
            ...
            try {
                ...
                //this.careStatus = Utilities.processRadiosByButton(this.careStatus, this.randomizeSection, false, defaultPendingRtdRadioButtonBy, defaultPendingTransferRadioButtonBy, defaultFollowUpApptRadioButtonBy, defaultPendingEvacRadioButtonBy);
...
//                }
        ...
        if (useDefaultTemplate) { // Should be one or the other, because once we push the Save Note button, that's it.
            try {
                ...
                //this.careStatus = Utilities.processRadiosByLabel(this.careStatus, this.randomizeSection, false, templatePendingRtdRadioLabelBy, templatePendingTransferRadioLabelBy, templateFollowUpApptRadioLabelBy, templatePendingEvacRadioLabelBy);
                this.careStatus = Utilities.processRadiosByButton(this.careStatus, this.randomizeSection, false,
