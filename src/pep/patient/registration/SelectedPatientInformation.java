...
//        selectedPatientInformation.sponsorSsn = Utilities.processText(sponsorSsnBy, selectedPatientInformation.sponsorSsn, Utilities.TextFieldType.SSN, selectedPatientInformation.randomizeSection, true); // sometimes erased
...
// so what happened above?  Did it finish?  Did it work?  The page will fail if the value isn't set.  (Or was it overwritten somehow?)
        ...
        selectedPatientInformation.rank = Utilities.processDropdown(rankBy, selectedPatientInformation.rank, selectedPatientInformation.randomizeSection, true); // off by one?
        selectedPatientInformation.patientCategory = Utilities.processDropdown(patientCategoryBy, selectedPatientInformation.patientCategory, selectedPatientInformation.randomizeSection, true);
